package com.matsg.battlegrounds.nms.v1_8_R3;
...
public class V1_8_R3 implements InternalsProvider {
    ...
    public void playChestAnimation(Location location, boolean open) {
        ...
        world.playBlockAction(blockPosition, tileEntity.w(), 1, open ? 1 : 0);
    }
    ...
    public void registerCustomEntities() {
        ...
        ((Map) ReflectionUtils.getField(net.minecraft.server.v1_8_R3.EntityTypes.class, "c", null)).put(zombieKey, CustomZombie.class);
        ((Map) ReflectionUtils.getField(net.minecraft.server.v1_8_R3.EntityTypes.class, "d", null)).put(CustomZombie.class, zombieKey);
        ((Map) ReflectionUtils.getField(net.minecraft.server.v1_8_R3.EntityTypes.class, "f", null)).put(CustomZombie.class, zombieId);
        ((Map) ReflectionUtils.getField(net.minecraft.server.v1_8_R3.EntityTypes.class, "c", null)).put(wolfKey, CustomWolf.class);
        ((Map) ReflectionUtils.getField(net.minecraft.server.v1_8_R3.EntityTypes.class, "d", null)).put(CustomWolf.class, wolfKey);
        ((Map) ReflectionUtils.getField(net.minecraft.server.v1_8_R3.EntityTypes.class, "f", null)).put(CustomWolf.class, wolfId);
    }
