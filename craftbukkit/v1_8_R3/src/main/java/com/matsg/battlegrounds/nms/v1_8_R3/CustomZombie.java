...
public class CustomZombie extends EntityZombie implements Zombie {
    ...
    public void clearPathfinderGoals() {
        ((List) ReflectionUtils.getField(PathfinderGoalSelector.class, "b", goalSelector)).clear();
        ((List) ReflectionUtils.getField(PathfinderGoalSelector.class, "c", goalSelector)).clear();
        ((List) ReflectionUtils.getField(PathfinderGoalSelector.class, "b", targetSelector)).clear();
        ((List) ReflectionUtils.getField(PathfinderGoalSelector.class, "c", targetSelector)).clear();
    }
