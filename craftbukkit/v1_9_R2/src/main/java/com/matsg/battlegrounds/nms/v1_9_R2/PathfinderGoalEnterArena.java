...
public class PathfinderGoalEnterArena extends PathfinderGoal {
    ...
    private com.matsg.battlegrounds.nms.v1_9_R2.CustomZombie zombie;
    private Navigation navigation;
    private Obstacle obstacle;
    private Plugin plugin;

    public PathfinderGoalEnterArena(com.matsg.battlegrounds.nms.v1_9_R2.CustomZombie zombie, Obstacle obstacle, Plugin plugin) {
        this.zombie = zombie;
