...
public enum XMaterial {
    ...
    XMaterial(String material, int data ){
    ...
    public static XMaterial requestXMaterial(String name, byte data){
        for (XMaterial material : XMaterial.values()){
            if (name.toUpperCase().equals(material.material) && ((byte) material.data) == data){
                return material;
            }
        }
        return null;
    ...
    public static XMaterial requestXMaterial(String name){
        for (XMaterial material : XMaterial.values()){
            if (name.toUpperCase().equals(material.material) && ((byte) material.data) == 0){
                return material;
            }
        }
        return null;
