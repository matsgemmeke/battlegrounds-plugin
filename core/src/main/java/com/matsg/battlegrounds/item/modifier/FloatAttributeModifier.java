...
public class FloatAttributeModifier implements AttributeModifier<Float> {
    ...
    public ValueObject<Float> modify(ValueObject<Float> valueObject, String[] args) {
        ...
        if (value != null && operator != null) {
            return new FloatValueObject(operator.apply(valueObject.getValue(), value).floatValue());
        }
        ...
        try {
            ...
            throw new AttributeModificationException("Unable to modify float attribute with regex " + regex, e);
        }
