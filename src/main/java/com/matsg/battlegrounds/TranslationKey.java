...
public enum TranslationKey {
    ...
    DESCRIPTION_OVERVIEW("command-description-overview"),
    ...
    VIEW_ARENA_OVERVIEW_TITLE("view-arena-overview-title"),
    ...
    VIEW_GAME_OVERVIEW_TITLE("view-game-overview-title"),
    VIEW_LOADOUT_MANAGER("view-title-loadout-manager"),
    VIEW_PLUGIN_OVERVIEW_GAME("view-plugin-overview-game"),
    VIEW_PLUGIN_OVERVIEW_GAME_ARENA("view-plugin-overview-game-arena"),
    VIEW_PLUGIN_OVERVIEW_GAME_GAMEMODE("view-plugin-overview-game-gamemode"),
    VIEW_PLUGIN_OVERVIEW_GAME_OVERVIEW("view-plugin-overview-game-overview"),
    VIEW_PLUGIN_OVERVIEW_GAME_PLAYERS("view-plugin-overview-game-players"),
    VIEW_PLUGIN_OVERVIEW_GAME_STATE("view-plugin-overview-game-state"),
    ...
    VIEW_ZOMBIES_OVERVIEW_TITLE("view-zombies-overview-title"),
