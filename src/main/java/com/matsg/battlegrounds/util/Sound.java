...
public enum Sound {
    ...
    CLICK("CLICK", "BLOCK_STONE_BUTTON_CLICK_OFF", "BLOCK_STONE_BUTTON_CLICK_ON", "UI_BUTTON_CLICK"),
    DOOR_CLOSE("DOOR_CLOSE", "BLOCK_WOODEN_DOOR_CLOSE", "BLOCK_IRON_DOOR_CLOSE"),
    DOOR_OPEN("DOOR_OPEN", "BLOCK_WOODEN_DOOR_OPEN", "BLOCK_IRON_DOOR_OPEN"),
    ...
    public static Sound getSound(String arg) {
        ...
        throw new IllegalArgumentException("Found no valid sound name for " + arg);
    }
